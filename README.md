...
2. Fast. It usually takes 1 ~ 3 secs with the lousy network service by my network supplier(parsing and displaying takes less than 0.4 secs). Much faster than fetching by web browser under the same network within the same time period.
3. Essential. No excessive info to distract from essential meanings and usage, like ads, quizzes, pics, and other useless data.
4. ONE DICT. Not many dictionaries with similar definitions take too much space and time and make people dizzy. Only the first and the most important dictionary Cambridge Organization displays on its website, and it can absolutely meets our needs, clear and to the point.
5. CONSIDERATE. If not found, in stead of simply displaying none, a related word suggestions page is fetched. Then you'll find maybe there was a typo or a slight variation will fit.
